...
int main(int argc, char *argv[]) {
	...
	double Start, DistributionTime, ResultTime, Finish, Duration;
	...
	if (ProcRank == 0) {
		printf("Distribution duration: %f, replication duration: %f\n",
				DistributionTime - Start, Finish - ResultTime);
	}
