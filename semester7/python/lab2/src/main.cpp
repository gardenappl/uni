...
std::string digit_vector_to_string(const std::vector<uint32_t>& digits, bool debug) {
...
std::string multiply_factors_to_string(const std::unordered_map<uint32_t, uint32_t>& factors) {
